...
# direct methods
.method private a(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Lcom/google/android/gms/internal/ch;
    .locals 1
    ...
    instance-of v0, p1, Lcom/google/android/gms/internal/ch;

    if-eqz v0, :cond_0

    check-cast p1, Lcom/google/android/gms/internal/ch;

    invoke-virtual {p1}, Lcom/google/android/gms/internal/ch;->b()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, p1, p2}, Lcom/google/android/gms/internal/ch;-><init>(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method private a(Landroid/graphics/drawable/Drawable;ZZZ)V
    ...
    invoke-interface {v0, v1, p1}, Lcom/google/android/gms/common/images/a;->a(Landroid/net/Uri;Landroid/graphics/drawable/Drawable;)V
...
.method private a(Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;ZZZ)V
    ...
    instance-of v0, p1, Lcom/google/android/gms/internal/cm;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/internal/cm;->a()I
    ...
    invoke-direct {p0, v0, p2}, Lcom/google/android/gms/common/images/e;->a(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Lcom/google/android/gms/internal/ch;
    ...
    instance-of v1, p1, Lcom/google/android/gms/internal/cm;
    ...
    :goto_3
    invoke-virtual {p1, v1}, Lcom/google/android/gms/internal/cm;->a(Landroid/net/Uri;)V
    ...
    :goto_4
    invoke-virtual {p1, v1}, Lcom/google/android/gms/internal/cm;->a(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/gms/internal/ch;->a(I)V
...
.method private a(Landroid/widget/TextView;ILandroid/graphics/drawable/Drawable;ZZ)V
    ...
    invoke-direct {p0, v0, p3}, Lcom/google/android/gms/common/images/e;->a(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Lcom/google/android/gms/internal/ch;
...
.method a(Landroid/content/Context;Landroid/graphics/Bitmap;Z)V
    ...
    invoke-static {p2}, Lcom/google/android/gms/internal/cn;->a(Ljava/lang/Object;)V
...
.method a(Landroid/content/Context;Z)V
    ...
    :cond_0
    invoke-direct {p0, v0, p2, v2, v2}, Lcom/google/android/gms/common/images/e;->a(Landroid/graphics/drawable/Drawable;ZZZ)V
